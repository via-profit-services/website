...
import content from '~content/docs/redis/v2.0/events.md';
      ...
      <Helmet>
        <title>
          {intl.formatMessage({
            ...
            description: 'Meta title of redis.v2.0 events',
          })}
        </title>
        <meta
          name="description"
          content={intl.formatMessage({
            defaultMessage: 'Redis Api',
            description: 'Meta description of redis.v2.0 events',
          })}
        />
      </Helmet>
      <nav>
        <Breadcrumbs>
          ...
          <Crumb
            ...
            label={
              <FormattedMessage
                defaultMessage="Api"
                description="Breadcrumbs. Redis events"
              />
            }
          />
        </Breadcrumbs>
