...
const Container = styled.div`
  ...
  @media all and (min-width: ${WITH_TRIGGER}px) {
    visibility: visible;
  }
`;
...
const DeviceInformer: React.FC = () => {
  ...
  const handleGoToMobile = () => {
    dispatch({ type: 'mode', payload: 'desktop' });
  };
  ...
  return (
    <Container>
      <Inner>
        ...
        <Description>
          <FormattedMessage defaultMessage="You should use the desktop version to view the site" />
        </Description>
        ...
        <Button onClick={handleGoToMobile}>
          <FormattedMessage defaultMessage="Switch to desktop version" />
        </Button>
      </Inner>
      <BackDrop />
    </Container>
