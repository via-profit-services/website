...
const Api = loadable(() => import('~/pages/Docs/core/v2.0.x/api'), {
  fallback: <LoadingIndicator />,
});

const Connections = loadable(
  () => import('~/pages/Docs/core/v2.0.x/connections'),
  { fallback: <LoadingIndicator /> },
);

const Context = loadable(() => import('~/pages/Docs/core/v2.0.x/context'), {
  fallback: <LoadingIndicator />,
});

const Examples = loadable(() => import('~/pages/Docs/core/v2.0.x/examples'), {
  fallback: <LoadingIndicator />,
});

const GettingStarted = loadable(
  () => import('~/pages/Docs/core/v2.0.x/getting-started'),
  { fallback: <LoadingIndicator /> },
);

const Introduction = loadable(
  () => import('~/pages/Docs/core/v2.0.x/introduction'),
  { fallback: <LoadingIndicator /> },
);

const Middlewares = loadable(
  () => import('~/pages/Docs/core/v2.0.x/middlewares'),
  { fallback: <LoadingIndicator /> },
);

const Typedefs = loadable(() => import('~/pages/Docs/core/v2.0.x/typedefs'), {
  fallback: <LoadingIndicator />,
});
