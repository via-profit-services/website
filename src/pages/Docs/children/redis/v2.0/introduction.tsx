...
import content from '~content/docs/redis/v2.0/introduction.md';
      ...
      <Helmet>
        <title>
          {intl.formatMessage({
            ...
            description: 'Meta title of redis.v2.0 introduction',
          })}
        </title>
        <meta
          name="description"
          content={intl.formatMessage({
            defaultMessage: 'Redis v2 introduction',
            description: 'Meta description of redis.v2.0 introduction',
          })}
        />
      </Helmet>
      <nav>
